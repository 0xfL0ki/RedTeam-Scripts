...
namespace NtMapViewOfSection
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var processName = Process.GetProcessesByName("explorer");
            //var target = processName[0].Id;

            var target = Process.GetProcessById(processName[0].Id);
            //var target = Process.GetProcessById(1460);
